...
(define the-test-suite
  '((modules-dans-simplest
    ...
    ;; in exercise 8.17 definition order doesn't have to be the same as
    ;; declaration order
    (example-8.4
     "
         module m1
...
"
    ...
    ;; this should fail, because in the declaration, t depends u, which means u
    ;; cannot depend on t, but in the definition, u depends t
    (lift-type-from-scope-order
     "
       module m1
        interface
         [opaque u
