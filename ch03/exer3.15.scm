...
;;; Note: its side effect is not expressible in our specification
...
;;; ---------------------- Test ----------------------
(eqv? (run "print 1") 1)
(eqv? (run "print let x = 1 in x") 1)
(eqv? (run "print +(1,2)") 1)
(eqv? (run "print let x = 8 in cons(x,let y = 3 in /(y, 2))") 1)
(eqv? (run "print let x = 8 in let y = 3 in cond greater?(x, y) ==> print x end") 1)
