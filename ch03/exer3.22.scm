#lang eopl
;;; NOTE: with Sllgen it is not possible to define such a concrete grammar,
;;; because Sllgen is a LL(1) parser but our specification is not LL(1), we may
;;; have to write our own parser (with another generator?) in order to complete
;;; this exercise
