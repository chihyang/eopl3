...
;;; ClassDecl  ::= class Identifier extends Identifier {FieldDecl}* {MethodDecl}*
;;;                a-class-decl (class-name super-name field-decls method-decls)
;;; FieldDecl  ::= static Identifier = Expression
;;;                a-static-field-decl (field-name field-exp)
;;; FieldDecl  ::= field Identifier
;;;                a-normal-field-decl (field-name)
...
(define let-grammar
  '((program ((arbno class-decl) expression) a-program)
    (class-decl ("class" identifier "extends" identifier
                 ...
                 (arbno method-decl))
                a-class-decl)
    (field-decl ("static" identifier "=" expression)
                 a-static-field-decl)
