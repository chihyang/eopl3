...
;;;                fieldref-exp (obj field-name)
;;; Expression ::= fieldset Expression Identifier = Expression
;;;                fieldset-exp (obj field-name exp)
;;; Expression ::= superfieldref Identifier
;;;                superfieldref-exp (field-name)
;;; Expression ::= superfieldset Identifier = Expression
;;;                superfieldset-exp (field-name exp)
;;; Expression ::= named-send Identifier Expression Identifier({Expression}*(,))
;;;                named-send-exp (class-name obj-exp method-name rands)
;;; Expression ::= named-fieldref Identifier Expression Identifier
;;;                named-fieldref-exp (class-name obj-exp field-name)
;;; Expression ::= named-fieldset Identifier Expression Identifier = Expression
;;;                named-fieldset-exp (class-name obj-exp field-name exp)
;;; Parse Expression
...
(define let-grammar
  '((program ((arbno class-decl) expression) a-program)
    ...
    (expression ("superfieldset" identifier "=" expression)
                superfieldset-exp)
    (expression ("named-send" identifier expression identifier "(" (separated-list expression ",") ")")
                named-send-exp)
    (expression ("named-fieldref" identifier expression identifier)
                named-fieldref-exp)
    (expression ("named-fieldset" identifier expression identifier "=" expression)
