...
;;; MethodDecl ::= MethodDefn
;;;                a-method-decl (method-defn)
;;; MethodDecl ::= "final" MethodDefn
;;;                a-final-method-decl (method-defn)
;;; MethodDefn ::= Property method Identifier ({Identifier}*(,)) Expression
...
(define let-grammar
  '((program ((arbno class-decl) expression) a-program)
    (class-decl ("class" identifier "extends" identifier
                 ...
                 (arbno method-decl))
                a-class-decl)
    (method-decl (method-defn)
                 a-method-decl)
    (method-decl ("final" method-defn)
                 a-final-method-decl)
    (method-defn ("method" identifier "(" (separated-list identifier ",") ")" expression)
                 default-method-defn)
    (method-defn (property "method" identifier "(" (separated-list identifier ",") ")" expression)
                 a-method-defn)
    (property ("private")
              private-prop)
    (property ("protected")
