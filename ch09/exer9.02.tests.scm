...
(require rackunit)
(require (only-in "exer9.02.scm"
                  [tests-for-parse tests-for-parse-ex02]
                  [tests-for-run tests-for-run-ex02]))
(define tests-for-parse (append tests-for-parse-ex02))
(define tests-for-run (append tests-for-run-ex02))
