...
"
    ...
    (default-access-check-1
     "
class c1 extends object
  private method initialize()1
  method m1()1
...
"
    ...
    (check-protected-outside-class
     "
class c1 extends object
  field public y
  method initialize() set y = 1
class c2 extends c1
  field protected y
  method initialize() begin super initialize(); set y = 2 end
let obj = new c2() in fieldref obj y"
     error)
    )
