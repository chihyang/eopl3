...
class c2 extends c1
  ...
  % this is invalid in exercise 9.7
...
class c2 extends c1
  ...
  method m2()list(x,y) % y is not accessible
...
class b extends a
  ...
  method g()
    list(i,j,k) % i is not accessible
  method h() super g()

class c extends b
  method g() super h()
  method h() -(k,-(0,j)) % k, j is not accessible
...
class c2 extends c1
  ...
  method m1 (u,v) -(-(x,u), -(y,v)) % x, y not accessible
  method m3 () 23
class c3 extends c2
  field x
  field z
  ...
  method m3 () -(x,-(y,z)) % y not accessible
let o3 = new c3()
in send o3 m1(7,8)
"
     error)
