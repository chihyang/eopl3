...
(define let-grammar
  '((program (expression) a-program)
    ...
    (expression ("let" (arbno identifier "=" expression) "in" expression)
                let-exp)
    (expression ("proc" "(" (arbno identifier ":" optional-type) ")" expression)
                proc-exp)
    (expression ("letrec" (arbno optional-type identifier "(" (arbno identifier ":" optional-type ")") "=" expression) "in" expression)
                letrec-exp)
