#lang eopl
;;; NodeInBintree ::= (Int Listof(Int))
;;; Bintree ::= '() | (NodeInBintree Bintree Bintree)
(define leaf (lambda () '()))
(define at-leaf? null?)
...
(define t1
  (insert-to-right-loc
   ...
   (insert-to-left-loc
    ...
    (number->bintree-loc 13))))
(move-to-left-loc t1)
(move-to-right-loc t1)
(at-leaf? (move-to-right-loc (move-to-left-loc t1)))
(insert-to-left-loc 15 t1)
